...
//
// All exported methods are safe to call from multiple goroutines: LDweixin
...
var messages = map[MsgKey]map[Language]string{
	...
	MsgUnknownCommand: {
		LangEnglish:            "`%s` is not a valid command, forwarding to AI...",
		LangChinese:            "`%s` 不是有效命令，已转发给 AI 处理",
		LangTraditionalChinese: "`%s` 不是有效命令，已轉發給 AI 處理",
		LangJapanese:           "`%s` は有効なコマンドではありません。AI に転送します",
		LangSpanish:            "`%s` no es un comando válido, reenviando a AI...",
	},
	MsgWelcome: {
		LangEnglish:            "👋 Connected to %s.\nSend a message to chat. /help for commands",
		LangChinese:            "👋 已连接到 %s。\n直接发消息即可与 AI 对话。\n/help 查看命令 · /list 查看对话 · /new 新建",
		LangTraditionalChinese: "👋 已連接到 %s。\n直接發訊息即可與 AI 對話。\n/help 查看命令 · /list 查看對話 · /new 新建",
		LangJapanese:           "👋 %s に接続しました。\nメッセージを送信して会話。/help でコマンド一覧",
		LangSpanish:            "👋 Conectado a %s.\nEnvía un mensaje para chatear. /help para comandos",
	},
	MsgHelp: {
		LangEnglish: "📖 Available Commands\n\n" +
			...
			"/restart\n  Restart LDweixin service\n\n" +
			"/status\n  Show system status\n\n" +
			"/version\n  Show LDweixin version\n\n" +
...
LangChinese: "📖 常用命令\n\n" +
		...
		LangSpanish: "📖 Comandos disponibles\n\n" +
			...
			"/restart\n  Reiniciar el servicio LDweixin\n\n" +
			"/status\n  Mostrar estado del sistema\n\n" +
			"/version\n  Mostrar versión de LDweixin\n\n" +
	...
	MsgHelpTitle: {
		LangEnglish:            "LDweixin Help",
		LangChinese:            "LDweixin 帮助",
		LangTraditionalChinese: "LDweixin 說明",
		LangJapanese:           "LDweixin ヘルプ",
		LangSpanish:            "LDweixin Ayuda",
	},
	...
	MsgProviderListEmpty: {
		...
		LangJapanese:           "プロバイダが設定されていません。\n\n`config.toml` または `LDweixin provider add` で追加してください。",
	...
	MsgStatusTitle: {
		...
		LangChinese: "LDweixin 状态\n\n" +
			...
			"语言: %s\n" +
			"%s" + "%s" + "%s" + "%s" + "%s" + "%s",
		LangTraditionalChinese: "LDweixin 狀態\n\n" +
			"項目: %s\n" +
			"Agent: %s\n" +
			"工作目錄: %s\n" +
			"平台: %s\n" +
		...
		LangJapanese: "LDweixin ステータス\n\n" +
			...
			"言語: %s\n" +
			"%s" + "%s" + "%s" + "%s" + "%s" + "%s",
		LangSpanish: "Estado de LDweixin\n\n" +
			"Proyecto: %s\n" +
			"Agente: %s\n" +
			"Directorio: %s\n" +
			"Plataformas: %s\n" +
	...
	MsgCardTitleStatus: {
		LangEnglish: "LDweixin Status", LangChinese: "LDweixin 状态", LangTraditionalChinese: "LDweixin 狀態",
		LangJapanese: "LDweixin ステータス", LangSpanish: "Estado de LDweixin",
	},
	...
	MsgRestarting: {
		LangEnglish:            "🔄 Restarting LDweixin...",
		LangChinese:            "🔄 正在重启 LDweixin...",
		LangTraditionalChinese: "🔄 正在重啟 LDweixin...",
		LangJapanese:           "🔄 LDweixin を再起動中...",
		LangSpanish:            "🔄 Reiniciando LDweixin...",
	},
	MsgRestartSuccess: {
		LangEnglish:            "✅ LDweixin restarted successfully.",
		LangChinese:            "✅ LDweixin 重启成功。",
		LangTraditionalChinese: "✅ LDweixin 重啟成功。",
		LangJapanese:           "✅ LDweixin の再起動が完了しました。",
		LangSpanish:            "✅ LDweixin se reinició correctamente.",
	},
	MsgUpgradeChecking: {
	...
	MsgRelaySetupHint: {
		LangEnglish:            "\n\n⚠️ This agent does not auto-inject LDweixin instructions.\nPlease run `/bind setup` or `/cron setup` to write instructions to %s.",
		LangChinese:            "\n\n⚠️ 当前 agent 不会自动注入 LDweixin 指令。\n请运行 `/bind setup` 或 `/cron setup` 将指令写入 %s。",
		LangTraditionalChinese: "\n\n⚠️ 當前 agent 不會自動注入 LDweixin 指令。\n請執行 `/bind setup` 或 `/cron setup` 將指令寫入 %s。",
		LangJapanese:           "\n\n⚠️ このエージェントは LDweixin の指示を自動注入しません。\n`/bind setup` または `/cron setup` を実行して %s に指示を書き込んでください。",
		LangSpanish:            "\n\n⚠️ Este agente no inyecta automáticamente las instrucciones de LDweixin.\nEjecute `/bind setup` o `/cron setup` para escribirlas en %s.",
	},
	MsgRelaySetupOK: {
		LangEnglish:            "✅ LDweixin instructions written to %s\nThe agent can now use relay, cron, and attachment send-back.",
		LangChinese:            "✅ LDweixin 指令已写入 %s\nagent 现在可以使用中继、定时任务和附件回传功能了。",
		LangTraditionalChinese: "✅ LDweixin 指令已寫入 %s\nagent 現在可以使用中繼、定時任務和附件回傳功能了。",
		LangJapanese:           "✅ LDweixin の指示を %s に書き込みました。\nエージェントがリレー、cron、添付ファイル返送を使えるようになりました。",
		LangSpanish:            "✅ Instrucciones de LDweixin escritas en %s\nEl agente ahora puede usar relay, cron y reenvío de adjuntos.",
	},
	MsgRelaySetupExists: {
		LangEnglish:            "ℹ️ LDweixin instructions already exist in %s — no changes made.",
		LangChinese:            "ℹ️ LDweixin 指令已存在于 %s 中，无需重复写入。",
		LangTraditionalChinese: "ℹ️ LDweixin 指令已存在於 %s 中，無需重複寫入。",
		LangJapanese:           "ℹ️ LDweixin の指示は既に %s に存在します。変更はありません。",
		LangSpanish:            "ℹ️ Las instrucciones de LDweixin ya existen en %s — sin cambios.",
	},
	...
	MsgSetupNative: {
		LangEnglish:            "✅ This agent natively supports LDweixin instructions — no setup needed.",
		LangChinese:            "✅ 当前 agent 已原生支持 LDweixin 指令，无需额外配置。",
		LangTraditionalChinese: "✅ 當前 agent 已原生支持 LDweixin 指令，無需額外配置。",
		LangJapanese:           "✅ このエージェントは LDweixin の指示をネイティブサポートしています。セットアップ不要です。",
		LangSpanish:            "✅ Este agente soporta nativamente las instrucciones de LDweixin — no se necesita configuración.",
	},
	MsgCronSetupOK: {
		LangEnglish:            "✅ LDweixin instructions written to %s\nThe agent can now use relay, cron, and attachment send-back.",
		LangChinese:            "✅ LDweixin 指令已写入 %s\nagent 现在可以使用中继、定时任务和附件回传功能了。",
	...
	MsgBuiltinCmdRestart: {
		LangEnglish:            "Restart LDweixin service",
		LangChinese:            "重启 LDweixin 服务",
		LangTraditionalChinese: "重啟 LDweixin 服務",
		LangJapanese:           "LDweixin サービスを再起動",
		LangSpanish:            "Reiniciar el servicio LDweixin",
	},
	MsgBuiltinCmdStatus: {
	...
	MsgBuiltinCmdVersion: {
		LangEnglish:            "Show LDweixin version",
		LangChinese:            "查看 LDweixin 版本",
		LangTraditionalChinese: "查看 LDweixin 版本",
		LangJapanese:           "LDweixin のバージョンを表示",
		LangSpanish:            "Mostrar versión de LDweixin",
	},
	MsgBuiltinCmdHelp: {
